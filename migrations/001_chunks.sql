...
-- deja re-apuntar rag/config.py a la tabla vieja para medir el corpus viejo con
-- el agente nuevo. Es la comparación que zanja si el rework del chunking sirvió.
-- ALTER TABLE chunks RENAME TO chunks_legacy_v1;
-- ALTER INDEX chunks_embedding_hnsw RENAME TO chunks_legacy_v1_embedding_hnsw;
--
-- CREATE TABLE chunks (
...
--   section       text,                          -- "3. VALORACIÓN INICIAL DE LOS HERIDOS"
--   subsection    text,                          -- "3.2 EL ABC"
--   page_start    int,
--   page_end      int,
